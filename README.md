...
1- Clone repository with its sub-modules using git bash and run **`generate.bat`** to make a visual studio solution which you will find inside build folder named **`t8-mod.sln`**, then you will have to bring up the vs project with it and compile the project with **release configuration**.
...
_In case you wanted to revert the game back to the original Battle.NET servers, just remove the proxy dll `XInput9_1_0.dll` from your game folder. You can put it back whenever you want to re-install the client._
